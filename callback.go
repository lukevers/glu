...
type TessBeginHandler func(tessType C.GLenum, polygonData interface{})
...
func goTessBeginData(tessType C.GLenum, tessPtr unsafe.Pointer) {
	...
	tess.beginData(C.GLenum(tessType), tess.polyData)
}
...
type TessErrorHandler func(errorNumber C.GLenum, polygonData interface{})
...
func goTessErrorData(errorNumber C.GLenum, tessPtr unsafe.Pointer) {
	...
	tess.errorData(C.GLenum(errorNumber), tess.polyData)
}
